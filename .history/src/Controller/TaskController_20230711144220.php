...
class TaskController extends AbstractController
{
    ...
    public function search(Request $request, TaskRepository $taskRepo , CategoryRepository $categoryRepo  ): Response {
 ...
 if ($form->isSubmitted() && $form->isValid()){
    ...
    if ($keyword) {
        $tasks = $taskRepo->findAllTasksBysearch($keyword, $category);
    }
 }
