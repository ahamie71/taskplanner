...
class TaskController extends AbstractController
{
  ...
  #[Route('/tasks/by-category/{categoryId}', name: 'tasks_by_category')]
    public function tasksByCategory (CategoryRepository $categoryRepo ,Request $request, TaskRepository $taskRepository, $categoryId): Response
    {
        $category = $categor->find($categoryId);
