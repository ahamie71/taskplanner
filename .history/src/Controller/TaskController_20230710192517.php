...
class TaskController extends AbstractController
{
    ...
    public function articlesByCategory(Tasq $tasks nRequest $request, $categoryId, TaskRepository $taskRepository ,EntityManagerInterface $entityManager): Response
    {
        ...
        $tasks = $articleRepository->findByCategory($category);
