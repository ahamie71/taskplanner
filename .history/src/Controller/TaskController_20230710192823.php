...
class TaskController extends AbstractController
{
    ...
    #[Route('/articles/by-category/{categoryId}', name: 'articles_by_category')]
    public function articlesByCategory(Task $tasks ,Request $request, $categoryId, TaskRepository $taskRepository ,EntityManagerInterface $entityManager): Response
    {
   
        
        $categor = $entityManager->getRepository(Category::class)->find($categoryId);
