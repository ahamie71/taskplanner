...
class TaskController extends AbstractController
{
    ...
    #[Route("/task/by-category/{id}", name: "taskByCategory")]
    public function searchByCategory($id, CategoryRepository $categoryRepo)
    {
        ...
        $tasks = $category->getTasks(); // Assuming you have a relationship between Category and Task entities

    return $this->render('task/index.html.twig', [
        'categoryid' => $category->getId()!== n
        'tasks' => $tasks,
    ]);
