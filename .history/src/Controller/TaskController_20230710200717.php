...
class TaskController extends AbstractController
{
    ...
    #[Route("/task/{categoryid}", name:"SearchTask")]
     public function searchByCategory(Category $category,$id, CategoryRepository $categoryRepo)
     {
    
        $category= $categoryRepo->findBy($id);
        return $this->render('task/c.html.twig', [
            'category' => $category
