...
class TaskController extends AbstractController
{
    ...
    public function search(TaskRepository $repoTask,EntityManagerInterface $entityManager)
    {
        ...
        $tasks = $entityManager->getRepository(Task::class)->findAlltasksBycategory(['category' => $category]);
